...
console.log(typeof first.nodeName);
console.log(first.tagName); // ElementNode 가 아니면  undefined를 출력한다는 차이가 있음
console.log(typeof first.tagName);
...
first.innerHTML += '<strong>likeLion</strong>'

// - textContent
console.log('first.textContent',first.textContent);

// * 요소 내의 텍스트에 접근
first.textContent = '멋사';
